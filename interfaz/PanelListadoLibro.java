...
public class PanelListadoLibro extends JPanel {
    ...
    private void mostrarDetallesLibroSeleccionado() {
        ...
        if (filaSeleccionada >= 0) {
            ...
            int indiceReal = Integer.parseInt(tablaLibros.getValueAt(filaSeleccionada, 3).toString());
            String detalles = this.controlador.obtenerDetallesLibroPorIndice(indiceReal);
    ...
    private void cargarDatosTabla() {
        ...
        try {
            ...
            ArrayList<String[]> listaLibros = controlador.listadoDeLibros();
    ...
    private void buscarLibros() {
        ...
        try {
            ...
            ArrayList<String[]> listaCompleta = controlador.listadoDeLibros();
